...
describe('Projects', () => {
  ...
  it('should not be able to update a repository that does not follow UUIDv4', async () => {
    await request(app).put(`/repositories/123`).expect(400)
  })
  it('should not be able to update a repository that does not exist', async () => {
    await request(app).put(`/repositories/d2dc2deb-a86a-453f-96b0-f0b0dc10d9d7`).expect(400)
  })
  ...
  it('should not be able to delete a repository that does not follow UUIDv4', async () => {
    await request(app).delete(`/repositories/123`).expect(400)
  })
  it('should not be able to update a repository that does not exist', async () => {
    await request(app).delete(`/repositories/d2dc2deb-a86a-453f-96b0-f0b0dc10d9d7`).expect(400)
  })
})
